...
for subdir in $(ls -d */); do
      ...
      if [ "$subdir_name" = "sq_handkp_ocr" ]; then
            ...
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/kmodel/hand_det.kmodel ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/kmodel/handkp_det.kmodel ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/kmodel/ocr_det.kmodel ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/kmodel/ocr_rec.kmodel ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/images/input_ocr.jpg ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/HZKf2424.hz ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/Asci0816.zf ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/dict_6625.txt ${k230_bin}/$subdir_name
      ...
      if [ "$subdir_name" = "bytetrack" ]; then
            ...
            cp -ar ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/images/bytetrack_data ${k230_bin}/$subdir_name
      ...
      if [ "$subdir_name" = "llamac" ]; then
            ...
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/llama.bin ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/tokenizer.bin ${k230_bin}/$subdir_name
      ...
      if [ "$subdir_name" = "puzzle_game" ]; then
            ...
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/kmodel/hand_det.kmodel ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/kmodel/handkp_det.kmodel ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/pintu.bin ${k230_bin}/$subdir_name
      ...
      if [ "$subdir_name" = "ocr" ]; then
            ...
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/dict_ocr_16.txt  ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/HZKf2424.hz ${k230_bin}/$subdir_name
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/utils/Asci0816.zf ${k230_bin}/$subdir_name
      ...
      if [ "$subdir_name" = "dec_ai_enc" ]; then
            ...
            cp -a ${SDK_RTSMART_SRC_DIR}/libs/kmodel/ai_poc/kmodel/face_detection_hwc.kmodel ${k230_bin}/$subdir_name
