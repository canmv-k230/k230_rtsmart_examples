#!/bin/bash
# Build and package K230 uvc_face_detection program (incremental build)
# Function: Use CMake and cross-compile toolchain to build uvc_face_detection example and collect ELF and utility files
